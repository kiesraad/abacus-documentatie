...
Er zijn een aantal verschillen in de implementatie van zetelverdeling tussen OSV2020 en Abacus. Deze verschillen betreffen uiterst zeldzame situaties:
...
## Volgorde van toewijzen van zetels aan gekozen kandidaten bij gelijk aantal stemmen

Het kan voorkomen dat meerdere kandidaten op een lijst evenveel voorkeursstemmen hebben gekregen, én dat de lijst voldoende zetels heeft om al die kandidaten een zetel toe te kennen. Al deze kandidaten zijn dan verkozen. In dit geval gebruikt Abacus de lijstvolgorde om zetels aan de kandidaten toe te kennen. OSV2020 doet dat niet. Dit leidt niet tot andere verkozen kandidaten, maar wel tot een andere volgorde van de verkozen kandidaten van een lijst.
