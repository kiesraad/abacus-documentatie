...
- Selecteer **Bestand kiezen** en selecteer het EML-bestand met de verkiezingsdefinitie (EML 110a).
...
![Verkiezingsdefinitie importeren en hashcode invullen](./img/verkiezing-toevoegen-hashcode-invullen.png)
