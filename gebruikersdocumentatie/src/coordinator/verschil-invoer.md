...
Controleer beide invoeren om na te gaan welke invoer overeenkomt met het proces-verbaal. Selecteer de correcte invoer en vervolgens **Opslaan** om deze te bewaren. De andere invoer wordt weggegooid en moet opnieuw gedaan worden. Bewaar geen van beide invoeren als ze allebei niet overeenkomen met het proces-verbaal.
