...
In Linux zijn er verschillende manieren om een statisch IP toe te wijzen. Verander het IP-adres op een snelle manier met de volgende opdracht:
...
- Op de computers zelf en op de printer zet je de wifi-functie uit zodat er ook op die manier geen internetverbinding kan worden gemaakt.
