...
Scope van deze use cases zijn de gemeenteraadsverkiezingen (GR), de waterschapsverkiezingen (WS) en, alleen voor het gemeentelijk stembureau (GSB), de verkiezingen voor Provinciale Staten (PS).
